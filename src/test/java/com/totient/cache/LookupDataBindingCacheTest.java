...
public class LookupDataBindingCacheTest {

  LookupCache lookupCache = null;

  @Before
  public void init() {
    lookupCache = LookupDataBindingCache.INSTANCE;
  }
  ...
  public void testGetSegmentFor02() {
    SegmentConfig[] segments = null;
    for (int i=0; i<=10000; i++) {      
      segments = lookupCache.getSegmentFor("org1", "paramName1", "paramVal1");
    }
